...
s8 GuiTrigger::WPAD_StickX(u8 stick) { return WPAD_Stick(stick, 0); }

s8 GuiTrigger::WPAD_StickY(u8 stick) { return WPAD_Stick(stick, 1); }

bool GuiTrigger::Left() {
    u32 wiibtn = WPAD_BUTTON_LEFT;

    if ((wpad->btns_d | wpad->btns_h) & (wiibtn | WPAD_CLASSIC_BUTTON_LEFT) ||
        (pad.btns_d | pad.btns_h) & PAD_BUTTON_LEFT || pad.stickX < -PADCAL ||
...
bool GuiTrigger::Right() {
    ...
    if ((wpad->btns_d | wpad->btns_h) & (wiibtn | WPAD_CLASSIC_BUTTON_RIGHT) ||
        (pad.btns_d | pad.btns_h) & PAD_BUTTON_RIGHT || pad.stickX > PADCAL ||
        WPAD_StickX(0) > PADCAL) {
...
bool GuiTrigger::Up() {
    ...
    if ((wpad->btns_d | wpad->btns_h) & (wiibtn | WPAD_CLASSIC_BUTTON_UP) ||
        (pad.btns_d | pad.btns_h) & PAD_BUTTON_UP || pad.stickY > PADCAL ||
...
bool GuiTrigger::Down() {
    ...
    if ((wpad->btns_d | wpad->btns_h) & (wiibtn | WPAD_CLASSIC_BUTTON_DOWN) ||
        (pad.btns_d | pad.btns_h) & PAD_BUTTON_DOWN || pad.stickY < -PADCAL ||
        WPAD_StickY(0) < -PADCAL) {
