...
void GuiElement::SetParent(GuiElement *e) { parentElement = e; }

GuiElement *GuiElement::GetParent() { return parentElement; }
...
void GuiElement::SetMinX(int x) { xmin = x; }

int GuiElement::GetMinX() { return xmin; }

void GuiElement::SetMaxX(int x) { xmax = x; }

int GuiElement::GetMaxX() { return xmax; }

void GuiElement::SetMinY(int y) { ymin = y; }

int GuiElement::GetMinY() { return ymin; }

void GuiElement::SetMaxY(int y) { ymax = y; }

int GuiElement::GetMaxY() { return ymax; }

int GuiElement::GetWidth() { return width; }

int GuiElement::GetHeight() { return height; }
...
void GuiElement::SetVisible(bool v) { visible = v; }

void GuiElement::SetAlpha(int a) { alpha = a; }
...
void GuiElement::SetScaleX(float s) { xscale = s; }

void GuiElement::SetScaleY(float s) { yscale = s; }
...
int GuiElement::GetStateChan() { return stateChan; }
...
void GuiElement::SetClickable(bool c) { clickable = c; }

void GuiElement::SetSelectable(bool s) { selectable = s; }

void GuiElement::SetHoldable(bool d) { holdable = d; }
...
void GuiElement::SetFocus(int f) { focus = f; }

int GuiElement::IsFocused() { return focus; }
...
void GuiElement::SetTrigger(u8 i, GuiTrigger *t) { trigger[i] = t; }

bool GuiElement::Rumble() { return rumble; }

void GuiElement::SetRumble(bool r) { rumble = r; }

int GuiElement::GetEffect() { return effects; }
...
void GuiElement::SetEffectGrow() { SetEffectOnOver(EFFECT_SCALE, 4, 110); }
...
void GuiElement::SetUpdateCallback(UpdateCallback u) { updateCB = u; }
...
int GuiElement::GetSelected() { return -1; }
